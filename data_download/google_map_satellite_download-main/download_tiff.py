...
def build_url(x, y, z):
    return "https://mt1.google.com/vt/lyrs=s&x={x}&y={y}&z={z}".format(x=x, y=y, z=z)
    # return "http://mts2.googleapis.com/vt?lyrs=s&x={x}&y={y}&z={z}".format(x=x, y=y, z=z)
...
def core(z):
    path = r"C:\\Users\\14398\\Desktop\\data\\gep\\"
    # 下载范围的 左上点经纬度
    point_lt = Point(123.153764865,41.75870841)
    # 下载范围的 右下点经纬度
    point_rb = Point(123.377459,41.64635739)
